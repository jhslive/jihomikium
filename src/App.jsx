  ...
  return (
    <div className="App">
      ...
      >
          ...
          >
            +{(Number(((((maxPrice/askPrice)-(maxPrice/askPrice)*0.0015)*bidPrice) -(maxPrice/askPrice)*bidPrice*0.0015)-maxPrice).toFixed(0)).toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g, ',')}
          </div>
           <div
            style={{
              position: "relative",
